...
var Route$1 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Upload customer reviews and get an executive crisis report, Jira tickets, and customer comms in minutes — powered by Gemini."
			},
			{
				name: "author",
				content: "CrisisRoom AI"
			},
			{
				property: "og:title",
				content: "CrisisRoom AI"
			},
			{
				...
				content: "AI-powered crisis response for product teams."
			},
			{
				property: "og:type",
				content: "website"
